"""Run StrategyAgent, ResearchAgent, then ContentAgent for the sample campaign."""
...
async def main() -> None:
    ...
    output = await ContentAgent().run(ContentAgentInput(strategy=strategy, research=research))
